...
export const PLAIN = {
  ...
  walletlessRequest:
    "You request this from your Merkado account. After review, Merkado prepares the listing automatically. You do not connect a wallet.",
  claimProceeds:
  ...
  payoutAddress:
    "Enter the Optimism Mainnet address the buyer pays once the offer is purchased. It is locked for this offer. Bank payout through Girasol is a coming-soon preview.",
  payoutAddressUnverified:
    "Use a real Optimism Mainnet 0x address. It is locked for this offer and not verified as yours by this demo. It is never shown on payer or purchaser screens.",
  payoutAddressLocked:
  ...
  payoutMethod:
    "For this walkthrough, the buyer pays the sale amount to your Optimism Mainnet payout address. Bank payout is later.",
  bankPayoutLater:
  ...
  usdc:
    "Digital dollars. The amount matches the rent one-to-one and settles on Optimism Mainnet.",
...
const EN: PayCopyEntry = {
  ...
  payByWalletBody:
    "Connect a wallet on Optimism Mainnet, approve the exact USDC amount, then pay the rent.",
...
const NL: PayCopyEntry = {
  ...
  payByWalletBody:
    "Verbind een wallet op Optimism Mainnet, keur het exacte USDC-bedrag goed en betaal dan de huur.",
...
const PAP: PayCopyEntry = {
  ...
  payByWalletBody:
    "Konektá un wallet na Optimism Mainnet, aproba e montante eksakto di USDC i paga e huur.",
