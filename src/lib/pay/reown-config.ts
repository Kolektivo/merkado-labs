...
import { optimism, type AppKitNetwork } from "@reown/appkit/networks";
...
/** Optimism Mainnet is the only wallet network in this deployment. */
export const reownNetworks: [AppKitNetwork, ...AppKitNetwork[]] = [optimism];

export const reownMetadata = {
  name: "Merkado Labs",
  description: "Merkado Direct · Merkado Pay (Optimism Mainnet)",
