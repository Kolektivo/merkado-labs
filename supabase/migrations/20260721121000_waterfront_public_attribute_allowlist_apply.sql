-- Waterfront public attribute allowlist (Labs only).
-- Forward-only replacement of public_property_listings + label helper.
-- Adds waterfront to the consumer attribute allowlist. No AI / hash / cron changes.
