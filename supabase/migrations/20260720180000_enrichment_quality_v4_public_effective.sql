...
comment on view public.public_property_listings is
  'Public-safe effective listing projection. Prefers v4 proposals, falls back to v3. Exposes only final effective values and display_description — never raw proposals, evidence, confidence, tokens, or costs.';
