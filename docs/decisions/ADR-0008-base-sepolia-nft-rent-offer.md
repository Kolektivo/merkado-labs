...
**Deployment note (2026-09-06):** ADR-0010 supersedes this record's network
selection and deployment assumptions. The contract economics and ERC-721 flow
remain the approved design; the active deployment is Optimism Mainnet.
