...
**Last updated:** August 19, 2026 (local automated verification re-run; GitHub Verify passed)
...
modules. GitHub Actions Verify also passed on `main` after that push
(workflow run 32228015203).
