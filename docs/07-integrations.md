...
| Supabase Auth (same Labs project) | Primary Labs identity: **email magic links**, with optional Google social sign-in. Auth identity is separate from wallet authorization. Identity-only OAuth authorization is supported. |
